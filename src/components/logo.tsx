...
const sizeStyles = {
  xs: {
    ...
    imageSize: 28,
    textClass: "text-xs font-semibold tracking-wide",
  },
  sm: {
    container: "flex items-center gap-3",
    imageSize: 38,
    textClass: "text-sm font-semibold sm:inline-block",
  },
  md: {
    container: "flex items-center gap-3.5",
    imageSize: 48,
    textClass: "text-base font-semibold",
  },
  lg: {
    container: "flex flex-col items-center justify-center gap-4 text-center",
    imageSize: 96,
    textClass: "text-2xl font-bold tracking-tight",
  },
  xl: {
    container: "flex flex-col items-center justify-center gap-5 text-center",
    imageSize: 120,
...
export const Logo = ({
  ...
  return (
    <div
      className={cn("flex items-center", current.container, containerClassName)}
    >
      <motion.svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 1500 1500"
        layoutId="logo-avatar"
        className={cn("shrink-0", className)}
        style={{
          width: current.imageSize,
          height: current.imageSize,
        }}
        transition={{ type: "spring", stiffness: 200, damping: 30 }}
        {...props}
      >
        <defs>
          <clipPath id="a5ba9a82db">
            <path
              d="M 252.597656 32 L 1327.347656 32 L 1327.347656 1469 L 252.597656 1469 Z M 252.597656 32 "
              clipRule="nonzero"
            />
          </clipPath>
          <clipPath id="3f5761d67f">
            <path
      ...
      <motion.span
        layoutId="logo-text"
        className={cn(
          "font-sans text-foreground select-none shrink-0 whitespace-nowrap",
          current.textClass,
        )}
        transition={{ type: "spring", stiffness: 200, damping: 30 }}
      >
